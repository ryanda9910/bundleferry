...
bundleferry is one file of instructions (`skill/SKILL.md`) plus docs and an installer.
Contributions that make it sharper or the install smoother are welcome.

## Good contributions

- **A miss** — if bundleferry didn't catch/do something it should, open an issue with
